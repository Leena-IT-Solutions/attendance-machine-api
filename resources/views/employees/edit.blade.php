    ...
    <div class="pb-12 max-w-2xl mx-auto">
        <form action="{{ route('employees.update', $employee) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="flex flex-col items-center justify-center space-y-4">
                <div x-data="photoCapture({ initial: '{{ $employee->photo ? '/storage/' . $employee->photo : '' }}' })" class="text-center">
                    ...
                    <!-- Preview circle -->
                    <div class="w-32 h-32 bg-slate-100 rounded-[2.5rem] border-2 border-slate-200 flex items-center justify-center overflow-hidden mx-auto transition-all">
            ...
            <div class="space-y-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $employee->name) }}" required
                        class="w-full px-5 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 placeholder-slate-300 text-slate-900 transition-all shadow-sm"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $employee->code) }}" required
                        class="w-full px-5 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 placeholder-slate-300 text-slate-900 transition-all shadow-sm"
