...
@section('meta_description', 'Track driver log times, monitor route schedules, and verify check-in coordinates with GPS geofencing and mobile contactless biometrics.')
...
<section class="max-w-7xl mx-auto px-6 py-16 text-center space-y-6 relative">
    ...
    <p class="text-slate-600 text-xs sm:text-sm max-w-xl mx-auto leading-relaxed">
        Verify transit check-ins using geofenced coordinates validation, monitor driver punch logs, and automate shifts schedules.
    </p>
...
<section class="bg-white border-y border-slate-100 py-16">
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        <div class="space-y-3">
            ...
            <h3 class="font-outfit font-bold text-slate-800 text-base">GPS Location Pins</h3>
            <p class="text-slate-550 text-xs leading-relaxed">
                Logs verified geographical coordinates automatically upon scan, confirming exact check-in locations.
            </p>
        </div>
        <div class="space-y-3">
...
<section class="max-w-7xl mx-auto px-6 py-16 space-y-12">
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-emerald-50/50 p-6 rounded-2xl border border-emerald-100/50 space-y-2">
            ...
            <p class="text-[11px] text-slate-650 leading-relaxed">
                Mobile face scan logs confirm drivers identity. Integrated GPS geofences verify start location details, uploading data directly to the cloud dashboard.
            </p>
        </div>
    </div>
</section>
