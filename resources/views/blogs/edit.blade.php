<x-app-layout>
    ...
    <div class="pb-24 max-w-2xl mx-auto">
        <form action="{{ route('blogs.update', $blog) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="category" id="category" value="{{ old('category', $blog->category) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="read_time" id="read_time" value="{{ old('read_time', $blog->read_time) }}" required
                ...
                <div class="space-y-2">
                    ...
                    <select name="cover_gradient" id="cover_gradient" required
                        ...
                        <option value="from-violet-500 to-indigo-500" {{ old('cover_gradient', $blog->cover_gradient) === 'from-violet-500 to-indigo-500' ? 'selected' : '' }}>Violet Indigo</option>
                        <option value="from-emerald-500 to-teal-500" {{ old('cover_gradient', $blog->cover_gradient) === 'from-emerald-500 to-teal-500' ? 'selected' : '' }}>Emerald Teal</option>
                        <option value="from-amber-500 to-orange-500" {{ old('cover_gradient', $blog->cover_gradient) === 'from-amber-500 to-orange-500' ? 'selected' : '' }}>Amber Orange</option>
                        <option value="from-rose-500 to-pink-500" {{ old('cover_gradient', $blog->cover_gradient) === 'from-rose-500 to-pink-500' ? 'selected' : '' }}>Rose Pink</option>
                        <option value="from-indigo-500 to-blue-500" {{ old('cover_gradient', $blog->cover_gradient) === 'from-indigo-500 to-blue-500' ? 'selected' : '' }}>Indigo Blue</option>
                    </select>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="3" required
                        ...
                        placeholder="A brief summary teaser text...">{{ old('excerpt', $blog->excerpt) }}</textarea>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="content" id="content" rows="12" required
                        ...
                        placeholder="<h2>Subheader</h2> <p>Paragraph lines...</p>">{{ old('content', $blog->content) }}</textarea>
